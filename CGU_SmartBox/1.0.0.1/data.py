...
class Box_1:
    ...
    def getRFID(self):
        return int(dataProcess.get().getNum("A/r"))

    def getMSG(self):
        return int(dataProcess.get().getNum("A/g"))
    ...
    def setHumidity(self, value: int or float):
        if (value < 0) | (value > 100):
            ...
            return False
        return dataProcess.set().setNum("A/b", int(value))
...
class Box_2:
    ...
    def setHumidity(self, value: int or float):
        if (value < 0) | (value > 100):
            ...
            return False
        return dataProcess.set().setNum("B/b", int(value))
...
class Box_3:
    ...
    def setHumidity(self, value: int or float):
        if (value < 0) | (value > 100):
            ...
            return False
        return dataProcess.set().setNum("C/b", int(value))
...
class outer:
    class requestOFF:
        def getResponse(self):
            return dataProcess.get().getString("responseOFF")

        def setResponse(self, value: str):
            return dataProcess.set().setString("responseOFF", str(value))

        def getString(self):
            return dataProcess.get().getString("requestOFF")

        def getTime(self):
            tempS = self.__class__().getString()
            return tempS[tempS.index("-") + 1:tempS.index("^")].replace("T", " ")

        def getIP(self):
            tempS = self.__class__().getString()
            return tempS[tempS.index("^") + 1:tempS.rindex("^")]

        def getLocation(self):
            tempS = self.__class__().getString()
            return tempS[tempS.rindex("^") + 1:]

        def setString(self, value: str):
            if value == "":
                return dataProcess.set().setString("requestOFF", str(value))
            if not ((value.count("-") == 3) & (value.count("^") == 2)):
                print("@requestOFF -> " + errString_type + str(value))
                return False
            return dataProcess.set().setString("requestOFF", str(value))

    class requestON:
        def getString(self):
            return dataProcess.get().getString("requestON")
        ...
        def setString(self, value: str):
            if value == "":
                return dataProcess.set().setString("requestON", str(value))
            if not ((value.count("-") == 3) & (value.count("^") == 2)):
                print("@requestOFF -> " + errString_type + str(value))
                return False
            return dataProcess.set().setString("requestON", str(value))
    ...
    def getPhoneNumber(self):
        return dataProcess.get().getString("phone")

    def getNote(self):
        return dataProcess.get().getString("msg")

    def getWeather(self):
        return dataProcess.get().getString("weather")
    ...
    def setPhoneNumber(self, value: str):
        return dataProcess.set().setString("phone", str(value))

    def setNote(self, value: str):
        return dataProcess.set().setString("msg", str(value))

    def setWeather(self, value: str):
        if value == "":
            return dataProcess.set().setString("weather", str(value))
        if not (value.count(",") == 2):
            print("@weather -> " + errString_type + str(value))
            return False
        return dataProcess.set().setString("weather", str(value))
